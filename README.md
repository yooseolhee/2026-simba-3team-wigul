...
우리에겐 지금, 마음 속 대화를 자연스럽게 꺼낼 수 있는 즐거운 서비스가 필요하다!
...
```bash
# 레포지토리 클론
git clone https://github.com/[username]/2026-simba-3team-wigul.git
